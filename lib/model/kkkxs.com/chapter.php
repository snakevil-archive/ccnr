<?php
/**
 * Represents as a novel chapter in `kkkxs.com'.
 *
...
class Chapter extends NrModel\Chapter
{
     ...
     * @var string
     */
    const PATTERN = '~^http://www\.kkkxs\.com/files/article/html/\d+/\d+/\d+\.html$~';
    ...
    protected function parse($content)
    {
        ...
        $s_ret = $this->crop('@<div id="content">(&nbsp;)*@', '@<div id="adbottom">@', $content);
        if (false === $s_ret)
            return $this;
